...
const styles = {
  ...
  variants: {
    destructive:
      "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-accent-negative-600)] [--checkbox-checked-border:var(--color-accent-negative-700)]/90",
    standard:
      "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-brand-500)] [--checkbox-checked-border:var(--color-brand-600)]/80",
  },
};

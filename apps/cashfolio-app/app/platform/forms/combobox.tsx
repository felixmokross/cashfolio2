    ...
    >
      <span
        ...
        className={clsx([
          ...
          // Invalid state
          "has-data-invalid:before:shadow-accent-negative-500/10",
        ])}
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Invalid state
            "data-invalid:border-accent-negative-500 data-invalid:data-hover:border-accent-negative-500 dark:data-invalid:border-accent-negative-500 dark:data-invalid:data-hover:border-accent-negative-500",
            // Disabled state
        ...
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-neutral-500 group-data-disabled:stroke-neutral-600 group-data-hover:stroke-neutral-700 sm:size-4 dark:stroke-neutral-400 dark:group-data-hover:stroke-neutral-300 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        ...
        // Focus
        "outline-hidden data-focus:bg-accent-neutral-500 data-focus:text-white",
        // Forced colors mode

...
import type { ReportPageViewProps } from "./-page-view";
...
export function clearReportStorySessionStorage(accountBookId: string) {
  ...
  const storageKeys = [
    ...
    `cashfolio:periodExpandedGroups:${accountBookId}:breakdown:cashFlow`,
...
export const baseOverview: ReportPageViewProps["overview"] = {
  ...
  cashFlowBreakdown: {
    ...
    items: [
      ...
      {
        id: "account:account-pocket-cash",
        label: "Pocket Cash",
        kind: "account",
        amount: -700,
        percentage: 20,
      ...
      {
        id: "account:account-savings-cash",
        label: "Savings Cash",
        kind: "account",
        amount: 200,
        percentage: 5.7,

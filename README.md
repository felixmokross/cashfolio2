...
Use Node 24 and pnpm 11 for local development. The repository includes
`.node-version` and `.nvmrc` files for version managers, and the root package
manifest pins the exact pnpm version.
